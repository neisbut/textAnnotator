...
c!=a);if(D||G&&"absolute"==f)e.y-=d.body.offsetTop;for(c=a;(c=hb(c))&&c!=d.body&&c!=h;)e.x-=c.scrollLeft,D&&"TR"==c.tagName||(e.y-=c.scrollTop)}e=ib;"none"!=Q(a,"display")?e(a):(c=a.style,d=c.display,f=c.visibility,g=c.position,c.visibility="hidden",c.position="absolute",c.display="inline",e(a),c.display=d,c.position=g,c.visibility=f);e=Ra("img",null,a)[0];e.style.transform="scaleX("+b.width/this.G+") scaleY("+b.height/this.F+")";e.style.webkitTransform=e.style.msTransform=e.style.transform}};function R(a){this.w=t(a)?[new O(a,"repeat")]:r(a)?a:[a]}w("tvs.Template",R);var S={squiggly:new R(new P('\x3cline y2\x3d"16.00" x2\x3d"20" y1\x3d"4.00" x1\x3d"10" stroke-linecap\x3d"round" stroke-width\x3d"5" stroke\x3d"{0}" fill\x3d"none"/\x3e\x3cline y2\x3d"4.00" x2\x3d"10" y1\x3d"16.00" x1\x3d"0" stroke-linecap\x3d"round" stroke-width\x3d"5" stroke\x3d"{0}" fill\x3d"none"/\x3e',20,20,"repeat")),solid:new R(new P('\x3cline y2\x3d"3" x2\x3d"5" y1\x3d"3" x1\x3d"0" stroke-linecap\x3d"round" stroke-width\x3d"2" stroke\x3d"{0}" fill\x3d"none"/\x3e',5,5,"repeat")),dotted:new R(new P('\x3cline y2\x3d"3" x2\x3d"4" y1\x3d"3" x1\x3d"0" stroke-dasharray\x3d"2, 2" stroke-width\x3d"2" stroke\x3d"{0}" fill\x3d"none"/\x3e',
4,5,"repeat")),dashed:new R(new P('\x3cline y2\x3d"3" x2\x3d"6" y1\x3d"3" x1\x3d"0" stroke-dasharray\x3d"4, 2" stroke-width\x3d"2" stroke\x3d"{0}" fill\x3d"none"/\x3e',6,5,"repeat")),"double":new R(new P('\x3cline y2\x3d"1" x2\x3d"5" y1\x3d"1" x1\x3d"0" stroke-linecap\x3d"round" stroke-width\x3d"1" stroke\x3d"{0}" fill\x3d"none"/\x3e\x3cline y2\x3d"4" x2\x3d"5" y1\x3d"4" x1\x3d"0" stroke-linecap\x3d"round" stroke-width\x3d"1" stroke\x3d"{0}" fill\x3d"none"/\x3e',5,5,"repeat")),combined:new R([new P('\x3ccircle cx\x3d"5" cy\x3d"5" r\x3d"5" fill\x3d"{0}" /\x3e',
10,10,"height"),new P('\x3cline y2\x3d"5" x2\x3d"10" y1\x3d"5" x1\x3d"0" stroke-linecap\x3d"round" stroke-width\x3d"5" stroke\x3d"{0}"/\x3e',10,10,"repeat"),new P('\x3ccircle cx\x3d"5" cy\x3d"5" r\x3d"5" fill\x3d"{0}" /\x3e',10,10,"height")])};w("tvs.AnnotatorDictionary.svgTemplates",S);function jb(){0!=kb&&(this.aa=Error().stack,u(this))}var kb=0;var lb=!E||E&&9<=J,mb=E&&!I("9");!G||I("528");F&&I("1.9b")||E&&I("8")||D&&I("9.5")||G&&I("528");F&&!I("8")||E&&I("9");function T(a,b){this.type=a;this.currentTarget=this.target=b}T.prototype.k=!1;T.prototype.defaultPrevented=!1;T.prototype.S=!0;T.prototype.preventDefault=function(){this.defaultPrevented=!0;this.S=!1};function nb(a){nb[" "](a);return a}nb[" "]=function(){};function U(a,b){a&&this.init(a,b)}x(U,T);l=U.prototype;l.target=null;l.relatedTarget=null;l.offsetX=0;l.offsetY=0;l.clientX=0;l.clientY=0;l.screenX=0;l.screenY=0;l.button=0;l.keyCode=0;l.charCode=0;l.ctrlKey=!1;l.altKey=!1;l.shiftKey=!1;l.metaKey=!1;l.Q=!1;l.p=null;
...
a.pageY;this.screenX=a.screenX||0;this.screenY=a.screenY||0;this.button=a.button;this.keyCode=a.keyCode||0;this.charCode=a.charCode||("keypress"==c?a.keyCode:0);this.ctrlKey=a.ctrlKey;this.altKey=a.altKey;this.shiftKey=a.shiftKey;this.metaKey=a.metaKey;this.Q=wa?a.metaKey:a.ctrlKey;this.state=a.state;this.p=a;a.defaultPrevented&&this.preventDefault();delete this.k};
l.preventDefault=function(){U.X.preventDefault.call(this);var a=this.p;if(a.preventDefault)a.preventDefault();else if(a.returnValue=!1,mb)try{if(a.ctrlKey||112<=a.keyCode&&123>=a.keyCode)a.keyCode=-1}catch(b){}};var ob="closure_listenable_"+(1E6*Math.random()|0),pb=0;function qb(a,b,c,d,f,g){this.c=a;this.proxy=b;this.src=c;this.type=d;this.capture=!!f;this.i=g;this.key=++pb;this.d=this.h=!1}function rb(a){a.d=!0;a.c=null;a.proxy=null;a.src=null;a.i=null};var sb={},V={},W={},X={};
function tb(a,b,c,d,f){if(r(b))for(var g=0;g<b.length;g++)tb(a,b[g],c,d,f);else if(c=ub(c),a&&a[ob])a.I.add(b,c,!1,d,f);else a:{if(!b)throw Error("Invalid event type");d=!!d;var e=V;b in e||(e[b]={b:0});e=e[b];d in e||(e[d]={b:0},e.b++);var e=e[d],g=u(a),h;if(e[g]){h=e[g];for(var k=0;k<h.length;k++)if(e=h[k],e.c==c&&e.i==f){if(e.d)break;h[k].h=!1;break a}}else h=e[g]=[],e.b++;k=vb();e=new qb(c,k,a,b,d,f);e.h=!1;k.src=a;k.c=e;h.push(e);W[g]||(W[g]=[]);W[g].push(e);a.addEventListener?a.addEventListener(b,
...
function yb(a,b){var c=a.c,d=a.i||a.src;if(a.h&&"number"!=typeof a&&a&&!a.d){var f=a.src;if(f&&f[ob]){var g=f.I,e=a.type;e in g.j&&na(g.j[e],a)&&(rb(a),0==g.j[e].length&&(delete g.j[e],g.ba--))}else{var g=a.type,h=a.proxy,e=a.capture;f.removeEventListener?f.removeEventListener(g,h,e):f.detachEvent&&f.detachEvent(g in X?X[g]:X[g]="on"+g,h);f=u(f);W[f]&&(h=W[f],na(h,a),0==h.length&&delete W[f]);rb(a);if(h=V[g][e][f])na(h,a),0==h.length&&(delete V[g][e][f],V[g][e].b--),0==V[g][e].b&&(delete V[g][e],
V[g].b--),0==V[g].b&&delete V[g];delete sb[a.key]}}return c.call(d,b)}
...
p.length-1;!h.k&&0<=q;q--)h.currentTarget=p[q],f&=xb(g,p[q],h);if(e)for(g=d[!1],q=0;!h.k&&q<p.length;q++)h.currentTarget=p[q],f&=xb(g,p[q],h)}else f=yb(a,h)}finally{p&&(p.length=0)}return f}d=new U(b,this);return f=yb(a,d)}var zb="__closure_events_fn_"+(1E9*Math.random()>>>0);function ub(a){return"function"==n(a)?a:a[zb]||(a[zb]=function(b){return a.handleEvent(b)})};function Ab(a,b,c){jb.call(this);this.O=a;this.N=b;this.K=c;this.D=v(this.P,this)}x(Ab,jb);l=Ab.prototype;l.m=!1;l.r=0;l.n=null;l.fire=function(){this.n||this.r?this.m=!0:Bb(this)};l.P=function(){this.n=null;this.m&&!this.r&&(this.m=!1,Bb(this))};function Bb(a){var b;b=a.D;var c=a.N;if("function"!=n(b))if(b&&"function"==typeof b.handleEvent)b=v(b.handleEvent,b);else throw Error("Invalid listener argument");b=2147483647<c?-1:m.setTimeout(b,c||0);a.n=b;a.O.call(a.K)};function Q(a,b){var c;a:{c=M(a);if(c.defaultView&&c.defaultView.getComputedStyle&&(c=c.defaultView.getComputedStyle(a,null))){c=c[b]||c.getPropertyValue(b)||"";break a}c=""}return c||(a.currentStyle?a.currentStyle[b]:null)||a.style&&a.style[b]}function gb(a){var b;try{b=a.getBoundingClientRect()}catch(c){return{left:0,top:0,right:0,bottom:0}}E&&(a=a.ownerDocument,b.left-=a.documentElement.clientLeft+a.body.clientLeft,b.top-=a.documentElement.clientTop+a.body.clientTop);return b}
...
function ib(a){var b=a.offsetWidth,c=a.offsetHeight,d=G&&!b&&!c;return(void 0===b||d)&&a.getBoundingClientRect?(a=gb(a),new Na(a.right-a.left,a.bottom-a.top)):new Na(b,c)};function Cb(a,b,c,d){this.type=c;this.color=d;this.H=b;this.a=[];this.o=a;a[b]=this}Cb.prototype.remove=function(){A(this.a,Wa);delete this.o[this.H];this.o=null};w("tvs.ElementAnnoationInfo.prototype.remove",Cb.prototype.remove);function Y(a,b,c,d){this.id=a||"annotator";this.s=c;this.Y=b;this.options={height:5,opacity:0.9};K(this.options,d||this.options);this.A=new Ab(v(this.R,this),50);a=this.id;b=v(this.A.fire,this.A);"undefined"===typeof Ya[a]&&(Ya[a]=b,tb(window,"resize",b))}Y.prototype.R=function(){var a;a="tvs-"+this.id;var b=document;a=b.querySelectorAll&&b.querySelector?b.querySelectorAll("."+a):b.getElementsByClassName?b.getElementsByClassName(a):Ra("*",a,void 0);b=v(this.t,this);A(a,b)};
Y.prototype.t=function(a){a.target&&(a=a.srcElement);var b=a["_"+this.id+"_info"];if(b){var c=document.body;a=a.getClientRects();for(var d=Math.min(a.length,b.a.length),f=this.Y[b.type],g=bb().y,e=0;e<d;e++){var h=Pa(a[e]);h.top+=g;h.bottom+=g;"undefined"===typeof h.width&&(h.width=h.right-h.left,h.height=h.bottom-h.top);var h=this.s.g(h,this.options.height),k=b.a[e].style;k.width=h.width+"px";k.left=h.left+"px";k.top=h.top+"px";Db(f,b.a[e],h)}for(e=d;e<b.a.length;e++)Wa(b.a[e]);for(e=b.a.length=
d;e<a.length;e++){h=Pa(a[e]);h.top+=g;h.bottom+=g;"undefined"===typeof h.width&&(h.width=h.right-h.left,h.height=h.bottom-h.top);d=L("div");d.style.position="absolute";var k=L("div"),h=this.s.g(h,this.options.height),p=Eb(f,b.color,h);k.appendChild(p);d.style.height=k.style.height=h.height+"px";d.style.width=0;k.style.width=h.width+"px";d.style.left=h.left+"px";d.style.top=h.top+"px";d.style.opacity=this.options.opacity;c.appendChild(d);d.appendChild(k);b.a.push(d);Db(f,p,h);La(d,"tvs-annotate-element",
!0);(function(a,b){setTimeout(function(){a.style.width=b.style.width},10)})(d,k)}}};function Fb(a,b,c,d){var f=r(b)?b:[b],g="tvs-"+a.id,e=[];Gb(a,b);A(f,function(b){e.push(b["_"+a.id+"_info"]=new Cb(b,"_"+a.id+"_info",c,d));La(b,g,!0);a.t(b)});return e}function Gb(a,b){var c="tvs-"+a.id;A(r(b)?b:[b],function(b){b["_"+a.id+"_info"]&&(b["_"+a.id+"_info"].remove(),La(b,c,!1))})}
function Eb(a,b,c){var d=L("table"),f=L("tr");d.appendChild(f);var g=0,e=a.w;A(e,function(a){"*"===a.width&&g++});var h=100*g/e.length,k;A(e,function(a,d){var g=L("td");fb(a,g,k,c,d,e.length,b,h);f.appendChild(g);k=g});return d}function Db(a,b,c){a=a.w;var d=Ra("td",null,b);A(a,function(a,b){a.u(d[b],c)})};function Z(){this.B=new Y("underliner",S,Za);this.q=new Y("highlighter",S,$a,{opacity:0.45});this.v=new Y("striker",S,ab)}w("tvs.Annotator",Z);Z.getTemplates=function(){return S};Z.isSvgSupported=function(){return document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure","1.1")};
Z.prototype.C=function(){var a=document.querySelectorAll("[data-annotate]"),b=this,c=["underline","highlight","strike"];A(a,function(a){var f=a.getAttribute("data-annotate")||"",g=f.split(/\s+/);if(3!==g.length)window.console.log('data-annotate problem with "'+f+'" 3 parameters expected');else if(0<=z(c,g[0]))b[g[0]](a,g[1],g[2]);else window.console.log('data-annotate problem with "'+f+'" unknown operation')})};Z.prototype.annotateDocument=Z.prototype.C;
Z.prototype.V=function(a){K(this.B.options,a);return this};Z.prototype.setUnderlineOptions=Z.prototype.V;Z.prototype.T=function(a){K(this.q.options,a);return this};Z.prototype.setHighlightOptions=Z.prototype.T;Z.prototype.U=function(a){K(this.v.options,a);return this};Z.prototype.setStrikeOptions=Z.prototype.U;Z.prototype.J=function(){return S};Z.prototype.getTemplates=Z.prototype.J;Z.prototype.Z=function(a,b,c){return Fb(this.B,a,b,c)};Z.prototype.underline=Z.prototype.Z;
Z.prototype.L=function(a,b,c){return Fb(this.q,a,b,c)};Z.prototype.highlight=Z.prototype.L;Z.prototype.strike=function(a,b,c){return Fb(this.v,a,b,c)};Z.prototype.strike=Z.prototype.strike;
function Hb(a,b,c,d){if("undefined"===typeof rangy)throw Error("Rangy Framework is not found");var f=rangy.getSelection(),g=a[b];a.l||(rangy.init(),a.l=rangy.createCssClassApplier("tvs-annotated-text"));a.l.applyToSelection();var e=[],h=[];A(f.getAllRanges(),function(b){A(b.getNodes(),function(b){b=a.l.getSelfOrAncestorWithClass(b);var f;if(f=b)f=Ha(b),f=0<=z(f,"tvs-annotated-text")&&!(0<=z(e,b));f&&(e.push(b),h.push(g.apply(a,[b,c,d])))})});return h}
Z.prototype.$=function(a,b){return Hb(this,"underline",a,b)};Z.prototype.underlineSelected=Z.prototype.$;Z.prototype.M=function(a,b){return Hb(this,"highlight",a,b)};Z.prototype.highlightSelected=Z.prototype.M;Z.prototype.W=function(a,b){return Hb(this,"strike",a,b)};Z.prototype.strikeSelected=Z.prototype.W;})();
