...
d;e<a.length;e++){h=Pa(a[e]);h.top+=g;h.bottom+=g;"undefined"===typeof h.width&&(h.width=h.right-h.left,h.height=h.bottom-h.top);d=L("div");d.style.position="absolute";var k=L("div"),h=this.s.g(h,this.options.height),p=Eb(f,b.color,h);k.appendChild(p);d.style.height=k.style.height=h.height+"px";d.style.width=0;k.style.width=h.width+"px";d.style.left=h.left+"px";d.style.top=h.top+"px";c.appendChild(d);d.appendChild(k);b.a.push(d);Db(f,p,h);La(d,"tvs-annotate-element",!0);(function(a,b){setTimeout(function(){a.style.width=
b.style.width},10)})(d,k)}}};function Fb(a,b,c,d){var f=r(b)?b:[b],g="tvs-"+a.id,e=[];Gb(a,b);A(f,function(b){e.push(b["_"+a.id+"_info"]=new Cb(b,"_"+a.id+"_info",c,d));La(b,g,!0);a.t(b)});return e}function Gb(a,b){var c="tvs-"+a.id;A(r(b)?b:[b],function(b){b["_"+a.id+"_info"]&&(b["_"+a.id+"_info"].remove(),La(b,c,!1))})}
function Eb(a,b,c){var d=L("table"),f=L("tr");d.appendChild(f);var g=0,e=a.w;A(e,function(a){"*"===a.width&&g++});var h=100*g/e.length,k;A(e,function(a,d){var g=L("td");fb(a,g,k,c,d,e.length,b,h);f.appendChild(g);k=g});return d}function Db(a,b,c){a=a.w;var d=Ra("td",null,b);A(a,function(a,b){a.u(d[b],c)})};function Z(){this.B=new Y("underliner",S,Za);this.q=new Y("highlighter",S,$a);this.v=new Y("striker",S,ab)}w("tvs.Annotator",Z);Z.getTemplates=function(){return S};Z.isSvgSupported=function(){return document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure","1.1")};
